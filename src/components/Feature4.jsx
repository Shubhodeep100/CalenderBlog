...
const Feature4 = () => {
  return (
    <section className="flex flex-col mt-10 gap-24">
      {/* Discover block */}
      ...
      <div className="flex flex-row flex-wrap fixed-contphone">
        ...
        <div className="w-6/12 fixed-contphone">
          <img
            src="https://framerusercontent.com/images/ow5cq9Ercs5KlWFqhMUsdUkCl8.png?scale-down-to=1024"
            alt="Calender"
          />
        </div>
        {/* 1 text block */}
        <div className="flex flex-col gap-10 space-order1">
          <div className="flex flex-col gap-16 max-w-lg">
            <div className="flex flex-col justify-start items-start  gap-4">
              <div className="bg-red-100 border border-gray rounded-l-full rounded-r-full py-1.5 px-6 flex justify-center items-center border-none">
